...
## Example
The [transition.sh](./transition.sh) script shows how you can send Shift-F11 using xdotool to find the mixxx app to send the key combo to.  In my case, my user's X11 session is on display :1.  You may need to change yours to :0.  
